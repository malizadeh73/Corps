        ...
        <nav id="navbar-section" class="navbar navbar-default navbar-static-top navbar-sticky" role="navigation">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand animated fadeInDownBig" href="base/index.blade.php"><img src="assets/img/slider/Office.png" width="100" alt="Office"></a>
                </div>
        
                <div id="navbar-spy" class="collapse navbar-collapse navbar-responsive-collapse">
                    <ul class="nav navbar-nav pull-right">
                        <li>
                            <a href="base/index.blade.php">Home</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="team.blade.php">Team</a>
                        </li>
                        <li class="active">
                            <a href="contact.blade.php"><span>Contact</span></a>
                        </li>
                    </ul>         
                </div>
            </div>
